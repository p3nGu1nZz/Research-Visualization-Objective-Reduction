...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full bg-cyber-black text-gray-200 selection:bg-cyber-cyan selection:text-black font-sans text-xl overflow-hidden relative">
      <ScanlineOverlay />
      ...
      <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[50] flex flex-col gap-3">
        <button 
          ...
          className="p-2 md:p-3 bg-cyber-dark/80 backdrop-blur border border-cyber-cyan/50 text-cyber-cyan rounded-full hover:bg-cyber-cyan hover:text-black transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(0,240,255,0.2)]"
        >
          <ChevronUp size={20} />
        </button>
        <button 
      ...
      {/* Main Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 border-b ${scrolled ? 'bg-cyber-black/90 backdrop-blur-xl border-cyber-gray shadow-[0_10px_30px_rgba(0,0,0,0.5)] py-2' : 'bg-transparent border-transparent py-2 md:py-4'}`}>
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          <div className="flex items-center gap-4 cursor-pointer group" onClick={() => scrollToSection('hero')}>
            <div className="relative">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-cyber-dark border border-cyber-yellow text-cyber-yellow flex items-center justify-center font-mono font-bold text-lg md:text-xl shadow-[0_0_15px_rgba(252,238,10,0.2)] group-hover:bg-cyber-yellow group-hover:text-black transition-all duration-300 z-10 relative">Ψ</div>
            ...
            <div className="flex flex-col">
                <span className="font-bold text-lg md:text-xl tracking-widest text-white leading-none cyber-glitch-text" data-text="RAWSON">
                  RAWSON
                </span>
                <span className="text-[8px] md:text-[10px] font-mono text-cyber-cyan tracking-[0.5em] uppercase pl-1 pt-1 opacity-70 group-hover:opacity-100 transition-opacity"> Protocol 2025</span>
            </div>
          </div>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="fixed inset-0 z-40 bg-cyber-black/98 backdrop-blur-xl flex flex-col items-center justify-center gap-8 md:gap-12 font-mono text-xl md:text-2xl animate-fade-in border-l-4 border-cyber-yellow">
            {['Preliminaries', 'Proposition', 'Proof', 'Corollary'].map((item) => (
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="mt-4 px-6 py-3 bg-cyber-dark border border-cyber-cyan text-cyber-cyan hover:bg-cyber-cyan hover:text-black transition-all flex items-center gap-2 font-bold"
            >
      ...
      <div 
        ...
        className="h-screen w-full overflow-y-auto overflow-x-hidden lg:snap-y lg:snap-mandatory scroll-smooth relative"
      >
        
        {/* Hero Section */}
        <header id="hero" className="relative min-h-[100svh] lg:h-screen w-full lg:snap-start flex flex-col justify-center items-center overflow-hidden border-b border-cyber-gray bg-cyber-black pt-20 pb-10 lg:py-0">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-3 mb-4 md:mb-6 px-4 py-1 border border-cyber-yellow/30 text-cyber-yellow font-mono text-[10px] md:text-xs tracking-[0.4em] uppercase bg-cyber-yellow/5 backdrop-blur-md"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-6xl md:text-8xl font-bold leading-none mb-6 md:mb-8 text-white tracking-tighter mix-blend-difference"
            >
            ...
            <motion.div
               ...
               className="max-w-3xl mx-auto mb-12 md:mb-16 space-y-4"
            >
               <p className="text-lg md:text-2xl text-cyber-cyan/80 font-light leading-relaxed font-mono">
                 > INITIALIZING OPERATOR ANNIHILATION SEQUENCE...
               </p>
               <p className="text-base md:text-xl text-gray-400 font-light px-4">
                 Unified proposition: Integration on timescale <MathTooltip tip="Characteristic Time Threshold (τc). The critical duration τ ≈ ℏ/E_G after which the superposition becomes unstable." title="DEF: TIME_THRESHOLD">τc</MathTooltip> forces state <MathTooltip tip="Quantum State Vector (|Ψ⟩). A ray in Hilbert space representing the complete physical state of a quantum system." title="DEF: STATE_VECTOR">|Ψ⟩</MathTooltip> collapse.
               </p>
            </motion.div>
        ...
        <section id="preliminaries" className="min-h-screen lg:h-screen w-full lg:snap-start flex flex-col justify-center border-b border-cyber-gray bg-cyber-black relative overflow-hidden py-20 lg:py-0">
          ...
          <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center h-full">
            <motion.div 
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
            ...
            >
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 text-white leading-tight tracking-tight">Preliminaries</h2>
              
              <p className="text-lg md:text-xl text-gray-300 mb-6 md:mb-8 leading-relaxed font-light">
                Let <MathTooltip tip="Separable Hilbert Space. An infinite-dimensional inner product space that is complete and has a countable orthonormal basis." title="DEF: HILBERT_SPACE">H</MathTooltip> be a separable Hilbert space and <MathTooltip tip="Quantum State Vector. A ray in Hilbert space representing the complete physical state of a quantum system." title="DEF: STATE_VECTOR">|Ψ⟩</MathTooltip> ∈ H with <MathTooltip tip="Normalization Condition. The inner product of the state vector with itself equals unity, ensuring total probability is 1." title="DEF: NORMALIZATION">⟨Ψ|Ψ⟩ = 1</MathTooltip>.
              </p>
              
              <TechBorder className="p-4 md:p-6 bg-cyber-dark border border-cyber-gray/50 shadow-2xl">
                ...
                <ul className="space-y-3 md:space-y-4 text-sm md:text-base font-mono text-gray-400">
                  <li className="flex items-center gap-4 group hover:text-white transition-colors cursor-default">
                      ...
                      <span><span className="text-cyber-yellow font-bold"><MathTooltip tip="Dynamical Generator (Ê(α)). Evolution operator defined by the system's Hamiltonian." title="DEF: OPERATOR">Ê(α)</MathTooltip></span> : Dynamical Generator</span>
                  </li>
                  <li className="flex items-center gap-4 group hover:text-white transition-colors cursor-default">
                      <span className="text-cyber-cyan opacity-50 group-hover:opacity-100">02</span> 
                      <span><span className="text-cyber-yellow font-bold"><MathTooltip tip="Vacuum Correction (Ĉ(α)). Operator accounting for vacuum energy fluctuations." title="DEF: OPERATOR">Ĉ(α)</MathTooltip></span> : Vacuum Correction</span>
                  </li>
                  <li className="flex items-center gap-4 group hover:text-white transition-colors cursor-default">
                      <span className="text-cyber-cyan opacity-50 group-hover:opacity-100">03</span> 
                      <span><span className="text-cyber-yellow font-bold"><MathTooltip tip="Chiral Correction (Ĉχ(α)). Asymmetry term in the operator expansion." title="DEF: OPERATOR">Ĉχ(α)</MathTooltip></span> : Chiral Correction</span>
                  </li>
                  <li className="flex items-center gap-4 group hover:text-white transition-colors cursor-default">
                      <span className="text-cyber-cyan opacity-50 group-hover:opacity-100">04</span> 
                      <span><span className="text-cyber-yellow font-bold"><MathTooltip tip="Gravitational Self-Energy Operator (Ĝ(α)). Represents the gravitational influence on the superposition." title="DEF: OPERATOR">Ĝ(α)</MathTooltip></span> : Gravitational Self-energy</span>
                  </li>
                </ul>
              </TechBorder>
            </motion.div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="lg:col-span-7 flex justify-center items-center mt-6 lg:mt-0"
            >
               <div className="relative group w-full max-w-xl">
                  ...
                  <div className="relative bg-cyber-black rounded-xl border border-cyber-cyan/30 p-4 md:p-8 backdrop-blur-sm">
        ...
        <section id="proposition" className="min-h-screen lg:h-screen w-full lg:snap-start flex flex-col justify-center bg-cyber-dark relative overflow-hidden py-20 lg:py-0">
             {/* Grid background */}
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-20 h-full flex flex-col justify-center">
                ...
                >
                     ...
                     <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 text-white tracking-tighter">Unified Proposition</h2>
                     <p className="text-lg md:text-2xl text-cyber-cyan font-light font-sans italic max-w-4xl mx-auto leading-normal">
                       "Objective Reduction by Operator Annihilation"
                     </p>
                </motion.div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center flex-grow">
                     <motion.div
                     ...
                     >
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 flex items-center gap-3">
                            <span className="text-cyber-cyan text-3xl md:text-4xl">#</span> Total Operator & Integral
                        </h3>
                        <p className="text-base md:text-lg text-gray-400 mb-8 leading-relaxed font-light">
                            Defining the Total Operator <span className="font-mono text-cyber-yellow font-normal"><MathTooltip tip="Total Operator. The sum of all contribution operators (Dynamical, Vacuum, Chiral, Gravitational) acting on the state." title="DEF: TOTAL_OPERATOR">T̂(α)</MathTooltip></span>. The reduction mechanism is executed by the integral over partition <span className="font-mono text-cyber-cyan font-normal"><MathTooltip tip="Partition Set. A discrete division of the continuous parameter space for summation." title="DEF: PARTITION">{`{αₖ}`}</MathTooltip></span>.
                        </p>
                        ...
                        <div className="space-y-6">
                            <TechBorder className="bg-cyber-black/50 p-6 border border-gray-800 backdrop-blur-md">
                                ...
                                <div className="mb-4 text-white text-base md:text-lg font-mono"><MathTooltip tip="Total Operator. The sum of all contribution operators (Dynamical, Vacuum, Chiral, Gravitational) acting on the state." title="DEF: TOTAL_OPERATOR">T̂(α)</MathTooltip> := Ê(α) + Ĉ(α) + Ĉχ(α) + Ĝ(α)</div>
                                <div className="flex flex-wrap items-center gap-2 md:gap-4 text-cyber-yellow text-base md:text-lg font-mono">
                                  <span><MathTooltip tip="Integrated Operator. The continuous accumulation of the Total Operator's action over the parameter space." title="DEF: INTEGRAL">∫ T̂(α)dα</MathTooltip> := </span>
                                  <div className="flex flex-col items-center justify-center leading-none text-[10px] text-gray-500">
                                    <span>LIM</span>
                                    <span>n→∞</span>
                                  </div>
                                  <span><MathTooltip tip="Riemann Sum. The discrete approximation of the operator integral." title="DEF: SUMMATION">Σ T̂(αₖ) Δα</MathTooltip></span>
                                </div>
                            </TechBorder>
                            
                            <div className="p-4 md:p-6 border-l-4 border-cyber-purple bg-gradient-to-r from-cyber-purple/10 to-transparent">
                                ...
                                <p className="font-mono text-lg md:text-xl text-white break-words">
                                   lim<sub>n→∞</sub> || <MathTooltip tip="Annihilation Action. The integrated operator acts on the state |Ψ⟩, driving its norm to zero." title="DEF: ANNIHILATION">Σ T̂(αₖ)Δα |Ψ⟩</MathTooltip> || = 0
                                </p>
                            </div>
                        </div>
                     </motion.div>
        ...
        <section id="proof" className="min-h-screen lg:h-screen w-full lg:snap-start flex flex-col justify-center bg-cyber-black relative border-t border-cyber-gray overflow-hidden py-20 lg:py-0">
             ...
             <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col h-full justify-center">
                ...
                >
                     ...
                     <h2 className="text-3xl sm:text-5xl font-bold text-white mb-2 tracking-tight">Proof of Execution</h2>
                     <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">Stepwise verification of the annihilation protocol.</p>
                </motion.div>

                {/* Grid Layout for Steps */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto mb-8 flex-grow content-center w-full">
                    {[
                        { 
                            step: "01", 
                            title: "INIT_PARTIAL_SUM", 
                            code: <>Ŝₙ := <MathTooltip tip="Riemann Sum. The discrete approximation of the operator integral." title="DEF: SUM">Σ T̂(αₖ)Δα</MathTooltip></>,
                            desc: "Define discrete sum operator."
                        },
                        { 
                            step: "02", 
                            title: "CHECK_BOUNDS", 
                            code: <>||<MathTooltip tip="Total Operator. The sum of all contribution operators (Dynamical, Vacuum, Chiral, Gravitational) acting on the state." title="DEF: OPERATOR">T̂(α)</MathTooltip>|| ≤ M</>,
                            desc: "Verify uniform boundedness."
                        },
                        { 
                            step: "03", 
                            title: "CONVERGENCE_SOT", 
                            code: <>Ŝₙ → <MathTooltip tip="Integrated Operator. The continuous accumulation of the Total Operator's action over the parameter space." title="DEF: INTEGRAL">∫ T̂(α)dα</MathTooltip></>,
                            desc: "Confirm strong topology convergence."
                        },
                        { 
                            step: "04", 
                            title: "ANNIHILATION_OP", 
                            code: <>lim Ŝₙ<MathTooltip tip="Quantum State Vector. A ray in Hilbert space representing the complete physical state of a quantum system." title="DEF: STATE">|Ψ⟩</MathTooltip> = 0</>,
                            desc: "Apply hypothesis (A1). State nullified."
                        },
                        { 
                            step: "05", 
                            title: "UNIQUE_LIMIT", 
                            code: <><MathTooltip tip="Annihilation Action. The integrated operator acts on the state |Ψ⟩, driving its norm to zero." title="DEF: ACTION">∫ T̂(α)dα |Ψ⟩</MathTooltip> = 0</>,
                            desc: "Uniqueness in Hilbert Space confirmed."
                        },
                        { 
                            step: "06", 
                            title: "CALC_THRESHOLD", 
                            code: <>τOR ∼ ℏ / <MathTooltip tip="Gravitational Self-Energy. The energy uncertainty arising from the difference in spacetime geometries associated with the superposed states." title="DEF: GRAVITY_ENERGY">G[Ψ]</MathTooltip></>,
        ...
        <section id="corollary" className="min-h-screen lg:h-screen w-full lg:snap-start flex flex-col justify-center bg-cyber-dark relative py-20 lg:py-0">
            <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center h-full">
                <motion.div 
                  initial={{ opacity: 0, scale: 0.95 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.8 }}
                  className="lg:col-span-6 relative h-[40vh] md:h-[45vh] w-full bg-cyber-black rounded-3xl overflow-hidden border border-cyber-gray shadow-2xl group"
                >
                ...
                >
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">Resonance Amplification</h2>
                    <p className="text-base md:text-lg text-gray-400 mb-8 leading-relaxed font-light">
                        Detecting conditions where vacuum correction <span className="font-mono text-cyber-cyan"><MathTooltip tip="Vacuum Correction. Operator representing quantum vacuum fluctuations." title="DEF: OPERATOR">Ĉ(α)</MathTooltip></span> triggers resonance amplification <span className="font-mono text-cyber-yellow"><MathTooltip tip="Differential Vacuum Contribution. The infinitesimal contribution of vacuum fluctuations over the interval dα to the total energy uncertainty." title="DEF: FLUCTUATION">δEvac(α)dα</MathTooltip></span>. Collapse probability increased.
                    </p>
                    ...
                    <div className="mt-8 p-6 border border-cyber-cyan/20 bg-gradient-to-br from-cyber-cyan/5 to-transparent rounded-2xl relative overflow-hidden group hover:border-cyber-cyan/50 transition-colors">
                        ...
                        <p className="font-mono text-base md:text-lg text-white relative z-10 italic border-l-4 border-cyber-cyan pl-6 py-1">
                            "The annihilation of <span className="not-italic text-cyber-cyan font-bold"><MathTooltip tip="Quantum State Vector. The physical state being acted upon." title="DEF: STATE">|Ψ⟩</MathTooltip></span> by the integrated operator... constitutes objective reduction."
                        </p>
        ...
        {/* Footer */}
        <footer id="footer" className="min-h-[50vh] lg:h-screen w-full lg:snap-start flex flex-col justify-center items-center py-20 bg-cyber-black border-t border-cyber-gray relative overflow-hidden">
